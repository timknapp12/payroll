      ...
      <div className="App">
        ...
        <div className="image-container">
          ...
          <div className="paragraph-container">
            ...
            <a href='in-house' ><p className='subheading'>1) In-House:</p></a>
        ...
        <div className="image-container">
          ...
          <div className="paragraph-container">
            <div className="image-container__text" id="small-font">  
            <p className='subheading'>2) 3rd-Party Processor:</p>
        ...
        <div className="image-container">
          ...
          <div className="paragraph-container">
            <div className="image-container__text" id="small-font">  
            <p className='subheading' >3) Employee Leasing:</p>
