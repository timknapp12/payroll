      ...
      <div className="App">
        ...
        <div className="image-container">
          ...
          <div className="paragraph-container">
            ...
            In its basic form processing payroll boils down to being able to provide an employee with a wage check or payment for their hours worked during a pay period.  The complexity of it has to do with the steps following the calculation of the total hours worked (X) times rate of pay (Y). The withholdings and deductions along with their corresponding tax filings, some to federal and some to state can really make processing payroll a thorn in your side. Staying compliant with all of that can be overwhelming. Not to mention Workers Compensation insurance, which is mandatory if you have employees.
        ...
        <div className="image-container">
          ...
          <div className="paragraph-container">
            ...
            <p className='subheading'>In-House:</p>
        ...
        <div className="image-container">
          ...
          <div className="paragraph-container">
            <div className="image-container__text" id="small-font">  
            <p className='subheading'>3rd Party Processor:</p>
        ...
        <div className="image-container">
          ...
          <div className="paragraph-container">
            <div className="image-container__text" id="small-font">  
            <p className='subheading' >Employee Leasing:</p>
